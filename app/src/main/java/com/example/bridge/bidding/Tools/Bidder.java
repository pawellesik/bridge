...
import com.example.bridge.bidding.Constraints.Aces;
import com.example.bridge.bidding.Constraints.AgreedStrain;
import com.example.bridge.bidding.Constraints.Balanced;
import com.example.bridge.bidding.Constraints.BetterMinor;
import com.example.bridge.bidding.Constraints.BetterSuit;
import com.example.bridge.bidding.Constraints.BidHistory;
import com.example.bridge.bidding.Constraints.Break;
import com.example.bridge.bidding.Constraints.Flat;
import com.example.bridge.bidding.Constraints.HasQuality;
import com.example.bridge.bidding.Constraints.HasShortness;
import com.example.bridge.bidding.Constraints.HasShownSuit;
import com.example.bridge.bidding.Constraints.IsCueBid;
import com.example.bridge.bidding.Constraints.JumpBid;
import com.example.bridge.bidding.Constraints.KeyCards;
import com.example.bridge.bidding.Constraints.Kings;
import com.example.bridge.bidding.Constraints.LogID;
import com.example.bridge.bidding.Constraints.LongestSuit;
import com.example.bridge.bidding.Constraints.Losers;
...
import com.example.bridge.bidding.Constraints.TwoSuiter;
...
public abstract class Bidder {
    ...
    public static HandConstraint fit(Suit suit) {
        return new PairMinShape.PairShowsMinShape(suit, 8, true);
    }
    ...
    public static StaticConstraint isLastBid(Call call) {
        return isLastBid(new Call[]{call});
    }
    ...
    public static Constraint sumPairAcesAndKings(int... count) {
        return new SumPairAcesAndKings(count);
    }

    public static Constraint sumPairAcesAndKings(int min, int max) {
        return new SumPairAcesAndKings(new Range(min, max));
    }

    public static Constraint sumPairAcesAndKings(String description, int... count) {
        return new SumPairAcesAndKings(description, count);
    }

    public static Constraint sumPairAcesAndKings(String description, int min, int max) {
        return new SumPairAcesAndKings(description, new Range(min, max));
    }
    ...
    public static HandConstraint pairHighCardPoints(Range range) {
        return new PairPoints.PairShowsPoints(range.getMin(), range.getMax(), true);
    }
    ...
    public static HandConstraint secondSuit(Suit exclude, int min) {
        return new TwoSuiter(exclude, min);
    }

    public static HandConstraint twoSuiter(int min) {
        return new TwoSuiter(null, min);
    }

    public static HandConstraint hasShortness(int min, int max) {
        return new HasShortness(min, max);
    }
