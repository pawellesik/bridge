...
public class RespondBid1NatC extends NatC {
    ...
    public static PositionCalls oneHeart(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._2S, highCardPoints(JUMP_AFTER_PASS), PASSED_HAND, ruleShow(1), shape(5, 10), id("RespondNatC.oneHeart _2S")),
                shows(Bid._3C, highCardPoints(JUMP_AFTER_PASS), PASSED_HAND, ruleShow(1), shape(5, 10), id("RespondNatC.oneHeart _3C")),
                shows(Bid._3D, highCardPoints(JUMP_AFTER_PASS), PASSED_HAND, ruleShow(1), shape(5, 10), id("RespondNatC.oneHeart _3D")),
                shows(Bid._2S, highCardPoints(JUMP_HAND), shape(5, 10), not(PASSED_HAND), ruleShow(1), id("RespondNatC.oneHeart _2S")),
                shows(Bid._3C, highCardPoints(JUMP_HAND), shape(5, 10), not(PASSED_HAND), ruleShow(1), id("RespondNatC.oneHeart _3C")),
                shows(Bid._3D, highCardPoints(JUMP_HAND), shape(5, 10), not(PASSED_HAND), ruleShow(1), id("RespondNatC.oneHeart _3D")),
