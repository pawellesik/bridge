...
public class Game {
    ...
    public static Game parse(String pbnGame) {
        Game game = new Game();
        List<com.example.bridge.bidding.BridgeBidder.PBN.FromString.PBNTag> tags = com.example.bridge.bidding.BridgeBidder.PBN.FromString.tokenizeTags(pbnGame);
        for (com.example.bridge.bidding.BridgeBidder.PBN.FromString.PBNTag tag : tags) {
