...
public class AcesAsk extends Bidder {
    ...
    public static Iterable<CallFeature> initiateConvention(PositionState ps) {
        ...
        bids.add(shows(Bid._4C, fit(partnerSuit), IS_ANY_JUMP, partner(isLastBid(Bid._3H)), pairPoints(SLAM_OR_BETTER), highCardPoints(ASK_ACES), setTrumpColor(Suit.Hearts), ruleShow(1), ruleDescription("Ask for Aces"), id(" initiateConventionAcesAsk 2")));
        bids.add(shows(Bid._4C, fit(partnerSuit), IS_ANY_JUMP, partner(isLastBid(Bid._3S)), pairPoints(SLAM_OR_BETTER), highCardPoints(ASK_ACES), setTrumpColor(Suit.Spades), ruleShow(1), ruleDescription("Ask for Aces"), id(" initiateConventionAcesAsk 3")));
        bids.add(shows(Bid._4C, fit(partnerSuit), setTrumpColor(partnerSuit), IS_ANY_JUMP, pairPoints(SLAM_OR_BETTER), highCardPoints(ASK_ACES), ruleShow(1), ruleDescription("Ask for Aces"), id(" initiateConventionAcesAsk 4")));
        bids.add(shows(Bid._4C, IS_ANY_JUMP, pairPoints(SLAM_OR_BETTER), shape(Suit.Hearts, 2, 4), shape(Suit.Spades, 2, 4), shape(Suit.Clubs, 2, 5), shape(Suit.Diamonds, 2, 5), partner(isLastBid(Bid._1NT)), ruleShow(1), ruleDescription("Ask for Aces"), id("initiateConventionAcesAsk 5")));
    ...
    public static Iterable<CallFeature> initiateConventionBlok(PositionState ps) {
        ...
        bids.add(shows(Bid._4NT, isJump(1), pairHighCardPoints(SLAM_OR_BETTER), highCardPoints(ASK_ACES), ruleDescription("Ask for Aces"), ruleShow(1), id("initiateConventionBlok AcesAsk 2")));
        bids.add(shows(Bid._4NT, CONTRACT_IS_AGREED_STRAIN, highCardPoints(ASK_ACES), pairHighCardPoints(SLAM_OR_BETTER), ruleDescription("Ask for Aces"), ruleShow(1), id("initiateConventionBlok AcesAsk 3")));
        bids.add(shows(Bid._4NT, IS_ANY_JUMP, pairHighCardPoints(SLAM_OR_BETTER), shape(Suit.Hearts, 2, 4), shape(Suit.Spades, 2, 4), shape(Suit.Clubs, 2, 5), shape(Suit.Diamonds, 2, 5), partner(isLastBid(Bid._1NT)), ruleShow(1), ruleDescription("Ask for Aces"), id("initiateConventionBlok AcesAsk 4")));
    ...
    public static PositionCalls askKing(PositionState ps) {
        ...
        if (suit != null) {
            ...
            choices.addRules(
                    ...
                    shows(bid, pairAces(3, 4), ruleShow(1), ruleDescription("Ask for Kings"), id("askKing isMajor 3-4")));
