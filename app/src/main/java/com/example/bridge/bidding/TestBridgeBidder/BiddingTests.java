...
public class BiddingTests {
    ...
    private static Collection<Object[]> loadPBNTests(String subdirectory) {
        ...
        // Using absolute path for consistency with the environment
        String basePath = "C:/Users/plesik/AndroidStudioProjects/Licytacja/app/src/test/java/com/example/licytacja/moje/TestBridgeBidder/";
        File dir = new File(basePath + subdirectory);
