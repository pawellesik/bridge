...
public class OpenBid1NatC extends NatC {
    ...
    public static final HandConstraint GameAfterNegat = highCardPoints(5, 6);
    ...
    public static Iterable<CallFeature> openSuit(PositionState ps) {
        ...
        if (ps.getSeat() < 3) {
            ...
            bids.add(shows(Bid._1S, OpenBiddingThirtSeat, shape(5, 10), ruleShow(1), id("OpenNatC.openSuit OpenAfterPass _1S")));
            bids.add(shows(Bid._1H, OpenBiddingThirtSeat, shape(5, 10), ruleShow(1), id("OpenNatC.openSuit OpenAfterPass _1H")));
            bids.add(shows(Bid._1D, OpenBiddingThirtSeat, shape(5, 10), ruleShow(1), id("OpenNatC.openSuit OpenAfterPass _1D")));
            bids.add(shows(Bid._1C, OpenBiddingThirtSeat, ruleShow(1), id("OpenNatC.openSuit OpenAfterPass _1C")));
        }
