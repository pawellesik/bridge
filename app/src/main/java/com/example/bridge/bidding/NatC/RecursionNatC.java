    ...
    public static PositionCalls recursionFindLowFitGame(PositionState ps) {
        PositionCalls choices = new PositionCalls(ps);
                choices.addRules(
                        ...
                        shows(Call.PASS, id("RecursionNatC.recursionFindLowFitGame Pass"))
                );
        return choices;
    }
    ...
    public static PositionCalls recursionFindFitGame(PositionState ps) {
        PositionCalls choices = new PositionCalls(ps);
            ...
            choices.addRules(
                    ...
                    shows(Bid._2H, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _2H")),
                    shows(Bid._2S, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _2S")),
                    shows(Bid._2C, shape(5, 10), id("RecursionNatC.recursionFindFitGame IS_REBID _2C")),
                    shows(Bid._2D, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _2D")),
                    shows(Bid._3H, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _3H")),
                    shows(Bid._3S, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _3S")),
                    shows(Bid._3C, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _3C")),
                    shows(Bid._3D, shape(5, 10), IS_NEW_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _3D")),

                    shows(Bid._2H, shape(4, 10), IS_NEW_SUIT, DECENT_PLUS_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _2H")),
                    shows(Bid._2S, shape(4, 10), IS_NEW_SUIT, DECENT_PLUS_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _2S")),
                    shows(Bid._3H, shape(4, 10), IS_NEW_SUIT, DECENT_PLUS_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _3H")),
                    shows(Bid._3S, shape(4, 10), IS_NEW_SUIT, DECENT_PLUS_SUIT, id("RecursionNatC.recursionFindFitGame IS_REBID _3S")),
