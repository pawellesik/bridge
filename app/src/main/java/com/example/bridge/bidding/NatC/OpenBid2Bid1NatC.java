...
public class OpenBid2Bid1NatC extends OpenBid1NatC {
    ...
    public static PositionCalls responderChangedSuitsHeart(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._4S, fit(), pairPoints(PAIR_GAME), id("OpenBid2NatC.responderChangedSuitsHeart _4S"))
    ...
    public static PositionCalls responderRaiseChangedSuitsToMinorHeart(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            ...
            choices.addRules(
                    ...
                    shows(Bid._4C, fit(), OpeningLowBidding, setTrumpColor(Suit.Clubs), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4C")),
                    shows(Bid._4D, fit(), OpeningLowBidding, setTrumpColor(Suit.Diamonds), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4D")),

                    shows(Bid._5C, fit(), OpeningInviteBidding, setTrumpColor(Suit.Clubs), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _5C")),
                    shows(Bid._5D, fit(), OpeningInviteBidding, setTrumpColor(Suit.Diamonds), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _5D"))
    ...
    public static PositionCalls responderRaiseChangedSuitsSpade(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4H, fit(), pairHighCardPoints(PAIR_GAME),  ruleShow(1),id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    ...
                    shows(Bid._3S, noFit(), shape(6, 10), IS_REBID, shape(ps.getPartner().getBid().getSuit(), 0, 1),  ruleShow(1),id("OpenBid2NatC.responderRaiseChangedSuitsSpade _3S")),
            ...
            choices.addRules(
                    ...
                    shows(Bid._4H, fit(), setTrumpColor(Suit.Hearts),  ruleShow(1),id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    shows(Bid._4H, shape(5, 10), OpeningInviteBidding,  ruleShow(1),id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    ...
                    shows(Bid._4D, fit(), OpeningLowBidding, setTrumpColor(Suit.Diamonds),  ruleShow(1),id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4D")),

                    shows(Bid._5C, fit(), setTrumpColor(Suit.Clubs),  ruleShow(1),id("OpenBid2NatC.responderRaiseChangedSuitsSpade _5C")),
                    shows(Bid._5D, fit(), OpeningInviteBidding, setTrumpColor(Suit.Diamonds), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _5D"))//,
            );
        }
        choices.addRules(CompeteNatC.compBids(ps));
        return choices;
