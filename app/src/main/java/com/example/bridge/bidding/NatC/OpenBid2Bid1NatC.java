...
public class OpenBid2Bid1NatC extends OpenBid1NatC {
    ...
    public static PositionCalls responderRaiseChangedSuitsToSpadeHeart(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._2NT, noFit(7), IS_NON_JUMP, partner(isLastBid(Bid._2C, Bid._2D, Bid._2H, Bid._2S)), othersAtLeast(2), id("OpenBid2NatC.responderRaiseChangedSuitsToSpadeHeart exit _2NT")),
    ...
    public static PositionCalls responderChangedSuitsSpade(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._4H, fit(), pairPoints(PAIR_GAME), id("OpenBid2NatC.responderChangedSuitsSpade _4H"))
