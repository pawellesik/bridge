...
public class OpenBid2Bid1NatC extends OpenBid1NatC {
    ...
    public static PositionCalls responderNegatStrong(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._2H, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderNegatStandard _2H")),
                shows(Bid._2S, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderNegatStandard _2S")),
                shows(Bid._3C, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderNegatStandard _3C")),
                shows(Bid._3D, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderNegatStandard _3D")),
                shows(Bid._2NT, isJump(1), OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderNegatStandard _2NT"))
        );
    ...
    public static PositionCalls responderdTrumpMajorClubStrong(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._3H, fit(), isJump(1), OpeningStrongBidding, setTrumpColor(Suit.Hearts), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3H")),
                shows(Bid._3S, fit(), isJump(1), OpeningStrongBidding, setTrumpColor(Suit.Spades), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3S")),

                shows(Bid._2S, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _2S")),
                shows(Bid._3C, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3C")),
                shows(Bid._3D, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3D")),
                ...
                shows(Bid._3NT, PAIR_BALANCED, OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3NT"))
        );
        choices.addRules(CompeteNatC.compBids(ps));
        return choices;
    }
    ...
    public static PositionCalls responderdTrumpMajorClubStandard(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._2H, DECENT_PLUS_SUIT, IS_NEW_SUIT, shape(4, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStandard _2H")),
    ...
    public static PositionCalls responderdTrumpMinorClubStrong(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._3S, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong _3S")),
                shows(Bid._3H, isJump(1), OpeningStrongBidding, shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong _3H")),
                shows(Bid._4D, fit(), isJump(1), OpeningStrongBidding, setTrumpColor(Suit.Diamonds), partner(isLastBid(Bid._2D)), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong fit() _4D")),
                shows(Bid._4C, fit(), isJump(1), OpeningStrongBidding, setTrumpColor(Suit.Clubs), partner(isLastBid(Bid._2C)), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong fit() _4C")),

                shows(Bid._3NT, PAIR_BALANCED, OpeningStrongBidding, ruleShow(1), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong _3NT")),

                shows(Bid._4C, noFit(), shape(5, 10), OpeningStrongBidding, partner(isLastBid(Bid._2D)), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong noFit() _4C")),
                shows(Bid._4D, noFit(), shape(5, 10), OpeningStrongBidding, partner(isLastBid(Bid._2C)), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong noFit() _4D"))
        );
        choices.addRules(CompeteNatC.compBids(ps));
        return choices;
    }
    ...
    public static PositionCalls responderdTrumpMinorClubStandard(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._3C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStandard _3C")),
                shows(Bid._3D, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStandard _3D"))
        );
        choices.addRules(CompeteNatC.compBids(ps));
        return choices;
    }
    ...
    public static PositionCalls responderdRaiseTrumpMinorClubStrong(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4H, noFit(), IS_ANY_JUMP, shape(5, 10), OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMinorClubStrong _4H")),
                    shows(Bid._4S, noFit(), IS_ANY_JUMP, shape(5, 10), OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMinorClubStrong _4S")),
                    shows(Bid._3NT, noFit(), OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMinorClubStrong _3NT"))
            );
        } else {
            choices.addRules(
                    properties(new Call[]{Bid._4H, Bid._4S}, RespondBid2Bid1NatC::secondBidRaiseTrumpMinorClubStrong),
    ...
    public static PositionCalls responderdRaiseTrumpMinorClubStandard(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._5D, fit(), pairHighCardPoints(PAIR_MINOR_GAME), setTrumpColor(Suit.Diamonds), id("OpenBid2NatC.responderdRaiseTrumpMinorClubStandard _4D")),
                    shows(Bid._5C, fit(), pairHighCardPoints(PAIR_MINOR_GAME), setTrumpColor(Suit.Clubs), id("OpenBid2NatC.responderdRaiseTrumpMinorClubStandard _4C")),
    ...
    public static PositionCalls responderdRaiseTrumpMajorClubStrong(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    properties(new Call[]{Bid._3S, Bid._4D, Bid._4C}, RespondBid2Bid1NatC::secondBidRaiseTrumpMajorClubStrong),
                    partnerBids(RecursionNatC::recursionFindFitGame),
                    shows(Bid._3S, shape(5, 10), noFit(), OpeningStrongBidding, partner(isLastBid(Bid._2H)), ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubClubStrong 3S")),
                    shows(Bid._4D, shape(5, 10), noFit(), OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubClubStrong 4D")),
                    shows(Bid._4C, shape(5, 10), noFit(), OpeningStrongBidding, ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubClubStrong 4C"))
            );
        } else {
            choices.addRules(
                    properties(new Call[]{Bid._3S, Bid._4D, Bid._4C}, RespondBid2Bid1NatC::secondBidRaiseTrumpMajorClubStrong),
    ...
    public static PositionCalls responderdRaiseTrumpMajorClubStandard(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4H, fit(), setTrumpColor(Suit.Hearts), pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubStandard fit 4H")),
                    shows(Bid._4S, fit(), setTrumpColor(Suit.Spades), pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubStandard fit 4S")),
                    ...
                    shows(Bid._3NT, noFit(), PAIR_BALANCED, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubStandard 3NT")),

                    shows(Bid._3C, shape(5, 10), noFit(), ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubStandard noFit 3C")),
                    shows(Bid._3H, shape(4, 10), noFit(), shape(Suit.Spades, 0, 2), partner(isLastBid(Bid._2S)), ruleShow(1), id("OpenBid2NatC.responderdRaiseTrumpMajorClubStandard noFit 3H"))
            );
        } else {
            choices.addRules(
                    properties(new Call[]{Bid._2S}, RespondBid2Bid1NatC::secondBidRaiseTrumpMajorClubStandard),
    ...
    public static PositionCalls responderChangedSuitsDiamond(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._2H, noFit(), shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _2H")),
                shows(Bid._1S, noFit(), shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _1S")),
                shows(Bid._2S, noFit(), shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _2S")),

                shows(Bid._2D, noFit(), IS_REBID, shape(6, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _2D")),
                shows(Bid._3D, noFit(), IS_REBID, shape(6, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _3D")),
                shows(Bid._2C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _2C")),

                shows(Bid._1NT, noFit(), PAIR_BALANCED, id("OpenBid2NatC.responderChangedSuitsDiamond _1NT")),
                shows(Bid._1NT, noFit(), BALANCED, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _1NT")),
    ...
    public static PositionCalls responderRaiseChangedSuitsMajorDiamond(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._2S, noFit(), shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _2S")),
                    shows(Bid._3D, noFit(), shape(6, 10), IS_REBID, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _3D")),
                    shows(Bid._3C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _3C")),
                    shows(Bid._3H, noFit(), pairHighCardPoints(PAIR_GAME), shape(4, 10), DECENT_PLUS_SUIT, OpeningInviteBidding, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _3H")),
                    shows(Bid._3H, noFit(), pairHighCardPoints(PAIR_GAME), shape(2, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _3H"))
    ...
    public static PositionCalls responderRaiseChangedSuitsMinorDiamond(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._3NT, PAIR_BALANCED, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsMinorDiamond _3NT"))
            );
        } else {
            choices.addRules(
                    properties(new Call[]{Bid._3D, Bid._3H, Bid._3S}, RespondBid2Bid1NatC::secondBidRaiseChangeSuitMinorDiamods),
    ...
    public static PositionCalls responderChangedSuitsHeart(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._3H, noFit(), IS_REBID, shape(7, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _3H")),

                shows(Bid._2S, fit(), setTrumpColor(Suit.Spades), partner(isLastBid(Bid._1S)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _2S")),

                shows(Bid._2H, shape(6), IS_REBID, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _2H")),

                shows(Bid._2S, noFit(), isOpeningBid(Bid._1H), shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _2S")),

                shows(Bid._2C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _2C")),
                shows(Bid._2D, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _2D")),

                shows(Bid._3C, fit(), OpeningInviteBidding, setTrumpColor(Suit.Clubs), partner(isLastBid(Bid._2C)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _3C")),
                shows(Bid._3D, fit(), OpeningInviteBidding, setTrumpColor(Suit.Diamonds), partner(isLastBid(Bid._2D)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _3D")),
                ...
                shows(Bid._4S, fit(), pairPoints(PAIR_GAME), partner(isLastBid(Bid._2S)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsHeart _4S"))
    ...
    public static PositionCalls responderRaiseChangedSuitsToSpadeHeart(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4S, fit(), pairHighCardPoints(PAIR_GAME), setTrumpColor(Suit.Spades), partner(isLastBid(Bid._2S)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4S")),
                    shows(Bid._3H, noFit(), shape(6, 10), IS_REBID, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3H")),
                    shows(Bid._3H, noFit(), shape(6, 10), IS_REBID, shape(ps.getPartner().getBid().getSuit(), 0, 1), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3H")),
                    shows(Bid._3S, noFit(), shape(5, 10), DECENT_PLUS_SUIT, shape(ps.getPartner().getBid().getSuit(), 0, 1), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3S")),

                    shows(Bid._2NT, noFit(7), IS_NON_JUMP, partner(isLastBid(Bid._2C, Bid._2D, Bid._2H, Bid._2S)), othersAtLeast(2), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsToSpadeHeart exit _2NT")),
                    shows(Bid._3NT, noFit(), PAIR_BALANCED, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3NT"))
            );
        } else {
            choices.addRules(
                    partnerBids(RecursionNatC::recursionFindFitGame),
                    ...
                    shows(Bid._3S, fit(), OpeningLowBidding, setTrumpColor(Suit.Spades), partner(isLastBid(Bid._2S)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3S")),
                    shows(Bid._4S, fit(), OpeningInviteBidding, setTrumpColor(Suit.Spades), partner(isLastBid(Bid._2S)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4S")),
                    shows(Bid._3H, noFit(), IS_REBID, shape(6, 10), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3H")),

                    shows(Bid._3S, fit(), shape(5, 10), OpeningLowBidding, id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3S")),

                    shows(Bid._3C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3C")),
                    shows(Bid._3D, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3D"))
    ...
    public static PositionCalls responderRaiseChangedSuitsToMinorHeart(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            ...
            choices.addRules(
                    ...
                    shows(Bid._3S, shape(5, 10), OpeningLowBidding, ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3S")),

                    shows(Bid._3C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3C")),
                    shows(Bid._3D, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3D")),

                    shows(Bid._4C, fit(), OpeningLowBidding, setTrumpColor(Suit.Clubs), partner(isLastBid(Bid._3C)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4C")),
                    shows(Bid._4D, fit(), OpeningLowBidding, setTrumpColor(Suit.Diamonds), partner(isLastBid(Bid._3D)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4D")),

                    shows(Bid._5C, fit(), OpeningInviteBidding, setTrumpColor(Suit.Clubs), partner(isLastBid(Bid._3C)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _5C")),
                    shows(Bid._5D, fit(), OpeningInviteBidding, setTrumpColor(Suit.Diamonds), partner(isLastBid(Bid._3D)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _5D"))
    ...
    public static PositionCalls responderRaiseChangedSuitsSpade(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4H, fit(), pairHighCardPoints(PAIR_GAME), partner(isLastBid(Bid._3H)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    shows(Bid._4H, shape(5, 10), pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    shows(Bid._3S, noFit(), shape(6, 10), IS_REBID, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _3S")),
                    ...
                    shows(Bid._3H, noFit(), shape(4, 10), IS_NEW_SUIT, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _3H")),
                    shows(Bid._4H, noFit(), shape(5, 10), IS_NEW_SUIT, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    shows(Bid._3NT, noFit(), PAIR_BALANCED, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _3NT"))
            );
        } else {
            choices.addRules(
                    partnerBids(RecursionNatC::recursionFindFitGame),
                    ...
                    shows(Bid._4H, fit(), setTrumpColor(Suit.Hearts), partner(isLastBid(Bid._3H)), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    ...
                    shows(Bid._3S, IS_REBID, shape(6, 10), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _3S")),
    ...
    public static PositionCalls responderChangedSuitsSpade(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._3S, noFit(), IS_REBID, shape(7, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _3S")),

                shows(Bid._2H, noFit(),  shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _2H")),
                shows(Bid._2S, shape(6), IS_REBID, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _2S")),

                shows(Bid._2C, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _2C")),
                shows(Bid._2D, noFit(), shape(5, 10), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _2D")),

                shows(Bid._3C, fit(), OpeningInviteBidding, setTrumpColor(Suit.Clubs), partner(isLastBid(Bid._3C)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _3C")),
                shows(Bid._3D, fit(), OpeningInviteBidding, setTrumpColor(Suit.Diamonds), partner(isLastBid(Bid._2D)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _3D")),

                shows(Bid._2NT, PAIR_BALANCED, partner(noFit()), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _2NT")),
                shows(Bid._3NT, PAIR_BALANCED, pairHighCardPoints(PAIR_GAME), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _3NT")),

                shows(Bid._4H, fit(), pairPoints(PAIR_GAME), partner(isLastBid(Bid._2H)), ruleShow(1), id("OpenBid2NatC.responderChangedSuitsSpade _4H"))
