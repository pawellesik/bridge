...
public class OpenBid2Bid1NatC extends OpenBid1NatC {
    ...
    public static PositionCalls responderdTrumpMajorClubStrong(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._3C, OpeningStrongBidding, shape(5, 10), isJump(1), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3C")),
                shows(Bid._3D, OpeningStrongBidding, shape(5, 10), isJump(1), ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStrong _3D")),
    ...
    public static PositionCalls responderdTrumpMajorClubStandard(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._1S, shape(4, 10), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStandard _1S")),
                shows(Bid._2H, shape(4, 10), IS_NEW_SUIT, DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderdTrumpMajorClubStandard _2H")),
    ...
    public static PositionCalls responderdTrumpMinorClubStrong(PositionState ps) {
        ...
        choices.addRules(
                ...
                shows(Bid._4C, OpeningStrongBidding, shape(5, 10), noFit(), partner(isLastBid(Bid._2D)), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong noFit() _4C")),
                shows(Bid._4D, OpeningStrongBidding, shape(5, 10), noFit(), partner(isLastBid(Bid._2C)), ruleShow(1), id("OpenBid2NatC.responderdTrumpMinorClubStrong noFit() _4D"))
        );
        choices.addRules(CompeteNatC.compBids(ps));
        return choices;
    }
    ...
    public static PositionCalls responderRaiseChangedSuitsMajorDiamond(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._3H, pairHighCardPoints(PAIR_GAME), shape(2, 10), noFit(), DECENT_PLUS_SUIT, ruleShow(1), id("OpenBid2NatC.responderChangedSuitsDiamond _3H"))
            ...
            choices.addRules(
                    ...
                    shows(Bid._3S, shape(4, 10), noFit(), partner(isLastBid(Bid._2H)), DECENT_PLUS_SUIT, id("OpenBid2NatC.responderChangedSuitsDiamond _3S")),
                    shows(Bid._3H, pairHighCardPoints(PAIR_GAME), OpeningInviteBidding, shape(4, 10), noFit(), partner(isLastBid(Bid._2S)), DECENT_PLUS_SUIT, id("OpenBid2NatC.responderChangedSuitsDiamond _3H")),
    ...
    public static PositionCalls responderRaiseChangedSuitsToSpadeHeart(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4S, pairHighCardPoints(PAIR_GAME), fit(), partner(isLastBid(Bid._2S)), setTrumpColor(Suit.Spades), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4S")),
                    ...
                    shows(Bid._3H, shape(6, 10), shape(ps.getPartner().getBid().getSuit(), 0, 1), noFit(), IS_REBID, ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3H")),
                    ...
                    shows(Bid._2NT, noFit(7), partner(isLastBid(Bid._2C, Bid._2D, Bid._2H, Bid._2S)), IS_NON_JUMP, othersAtLeast(2), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsToSpadeHeart exit _2NT")),
                    shows(Bid._3NT, pairHighCardPoints(PAIR_GAME), noFit(), PAIR_BALANCED, ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3NT"))
            );
        } else {
            choices.addRules(
                    partnerBids(RecursionNatC::recursionFindFitGame),
                    ...
                    shows(Bid._3S, OpeningLowBidding, fit(), partner(isLastBid(Bid._2S)), setTrumpColor(Suit.Spades), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3S")),
                    shows(Bid._4S, OpeningInviteBidding, fit(), partner(isLastBid(Bid._2S)), setTrumpColor(Suit.Spades), ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _4S")),
                    shows(Bid._3H, shape(6, 10), noFit(), IS_REBID, ruleShow(1), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3H")),

                    shows(Bid._3S, OpeningLowBidding, shape(5, 10), fit(), id("OpenBid2NatC.responderRaiseChangedSuitsHeart _3S")),
