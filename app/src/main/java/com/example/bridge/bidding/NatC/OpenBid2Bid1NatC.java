    ...
    public static PositionCalls responderRaiseChangedSuitsSpade(PositionState ps) {
        ...
        if (ps.getPartner().isPassedHand()) {
            choices.addRules(
                    ...
                    shows(Bid._4H, fit(), pairHighCardPoints(PAIR_GAME), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    ...
                    shows(Bid._3H, noFit(), shape(4, 10), IS_NEW_SUIT, pairHighCardPoints(PAIR_GAME), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _3H")),
                    shows(Bid._4H, noFit(), shape(5, 10), IS_NEW_SUIT, pairHighCardPoints(PAIR_GAME), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
            ...
            choices.addRules(
                    ...
                    shows(Bid._4H, fit(), setTrumpColor(Suit.Hearts), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _4H")),
                    ...
                    shows(Bid._5C, fit(), setTrumpColor(Suit.Clubs), id("OpenBid2NatC.responderRaiseChangedSuitsSpade _5C")),
