...
public class Auction extends ArrayList<Auction.AnnotatedCall> {
    ...
    public void addCall(Call call, String note) {
    ...
    public boolean isValid() {
        return ContractState.isValidAuction(game.getDealer(), getCalls());
    }
    ...
    public String toString() {
        ...
        sb.append("[Auction \"").append(game.getDealer().name()).append("\"]\n");
        ...
        if (numCallsThisLine > 0) sb.append("\n");
