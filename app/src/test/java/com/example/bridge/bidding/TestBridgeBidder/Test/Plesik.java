package com.example.bridge.bidding.TestBridgeBidder.Test;
...
public class Plesik {
    ...
    public void testAILicytacja() {
        ...
        game.getDeal().put(Direction.N, Hand.parse("QT7432.7.AKJ.Q93"));
        game.getDeal().put(Direction.S, Hand.parse("A6.AKT52.T75.K42"));
